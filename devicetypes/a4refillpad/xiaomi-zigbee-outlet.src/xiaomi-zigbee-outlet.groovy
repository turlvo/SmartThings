...
private Map parseCatchAllMessage(String description) {
	...
	log.debug "parseCatchAllMessage>> cluster: $cluster"
...
def off() {
	...
	"st cmd 0x${device.deviceNetworkId} 0x3E 0x0741 0 {}"    
}

def on() {
   log.debug "on()"
	sendEvent(name: "switch", value: "on")
    "st cmd 0x${device.deviceNetworkId} 0x3E 0x0741 1 {}"    
...
def refresh() {
    ...
    [
        "st rattr 0x${device.deviceNetworkId} 1 0x0100 0", "delay 500",        
